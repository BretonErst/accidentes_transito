...
# filter data for state 11 and municipality 20
dt01 <- dt00 %>% 
  janitor::clean_names() %>% 
  filter(edo == 11, mpio == 20) %>% 
...
dt01 %>% 
  ...
  labs(title = "¿Cuántos accidentes de tránsito ocurren en León?",
       subtitle = "Ocurridos en zonas urbana y semiurbanas del territorio municipal de León por semana",
       x = NULL,
       y = "Accidentes",
...
dt01 %>% 
  ...
  labs(title = "¿En qué proporción de los accidentes vehiculares se registran personas heridas?",
       subtitle = "Accidentes de tránsito ocurridos en zonas urbana y semiurbanas de León por semana",
       x = NULL,
...
ggsave("image/leo_percent.jpg", device = "jpeg", dpi = "retina")
...
dt01 %>% 
  ...
  labs(title = "¿Cuándo ocurren los accidentes de tránsito en León?",
...
dt01 %>% 
  ...
  geom_col(position = "dodge", alpha = 0.8) +
  labs(title = "¿Qué causa los accidentes vehiculares en León?",
...
ggsave("image/leon_factores.jpg", device = "jpeg", dpi = "retina")
...
dt01 %>% 
  ...
  theme(text = element_text(family = "Encode Sans Condensed"),
        ...
        panel.grid = element_line(color = "grey95")) +
  labs(title = "¿A qué hora ocurren los accidentes vehiculares en León?",
  ...
  ggsave("image/leon_hora_01.jpg", device = "jpeg", dpi = "retina")
